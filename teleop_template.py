...
if __name__=="__main__":
    ...
    pub_right = rospy.Publisher('/rk_bot/right_wheel_controller/command', Float64, queue_size=10) # Add your topic here between ''. Eg '/my_robot/steering_controller/command'
    pub_left = rospy.Publisher('/rk_bot/left_wheel_controller/command', Float64, queue_size=10)
    pub_move = rospy.Publisher('/rk_bot/rear_wheels_controller/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
